...
namespace Client5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            // ------ УСПЕШНО --------------------------------------------------
            //{
            //    IWriter writer = new FileWriter(@"C:\Users\mdxbu\Labs\4SEMESTR\паттерны проектирования\my.txt");
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\mdxbu\Labs\4SEMESTR\паттерны проектирования\test2.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\mdxbu\Labs\4SEMESTR\паттерны проектирования\test4.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\mdxbu\Labs\4SEMESTR\паттерны проектирования\test12.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
                string? result = hash.Save("BBBBCCCCC");
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\mdxbu\Labs\4SEMESTR\паттерны проектирования\test13.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
                string? result = hash.Save("BBBBCCCCC");
